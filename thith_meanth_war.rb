...
if user_input.include? "s"
  ...
  until user_input.include? "s"
    print "Your paragraph dothn't contain any S's in it my friend. Type a thmall paragraph for me pleath. I'll make it thound thuper funny. Make thure to include a lot of th's! "
    user_input = gets.chomp.downcase!
end
